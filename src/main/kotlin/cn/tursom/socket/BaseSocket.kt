...
open class BaseSocket(private val socket: Socket) {
	...
	fun recv(
		...
		return String(smartRecvByteArray(maxsize, readTimeout, firstTimeout, exception, timeoutException))
	}
