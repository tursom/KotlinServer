package cn.tursom.utils.encrypt
...
class AES(secKey: SecretKey) : Encrypt {
	...
	constructor(key: ByteArray, keySize: Int = key.size, offset: Int = 0) : this(SecretKeySpec(key, offset, keySize, "AES"))
